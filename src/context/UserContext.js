...
const BASE_URL="https://expense-tracker-backend-6zk6lzhon-akashreddy2003.vercel.app/";
...
export const UserProvider=({children})=>{
    ...
    const login=async(lemail,lpass)=>{
        await axios.post("https://expense-tracker-backend-6zk6lzhon-akashreddy2003.vercel.app/login",{email:lemail,password:lpass}).then((res)=>{
    ...
    const register=async(name,remail,rpass)=>{
        await axios.post("https://expense-tracker-backend-6zk6lzhon-akashreddy2003.vercel.app/register",{name:name,email:remail,password:rpass}).then((res)=>{
